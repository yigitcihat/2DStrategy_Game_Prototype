...
public class GridRenderer : MonoBehaviour
{
    ...
    internal IGridManager inventory;
    GridRenderMode _renderMode;
    private bool _haveListeners;
    private Pool<Image> _imagePool;
    private Image[] _grids;
    private Dictionary<IProductionItem, Image> _items = new Dictionary<IProductionItem, Image>();
    ...
    /// </summary>
    public void SetInventory(IGridManager inventoryManager, GridRenderMode renderMode)
    {
        OnDisable();
    ...
    */
    private void HandleItemAdded(IProductionItem item)
    {
        var img = CreateImage(item.sprite, false);

        if (_renderMode == GridRenderMode.Single)
        {
    ...
    */
    private void HandleItemRemoved(IProductionItem item)
    {
    ...
    */
    ...
    public void SelectItem(IProductionItem item, bool blocked, Color color)
    {
        if (item == null) { return; }
        ClearSelection();
    ...
    */
    internal Vector2 GetItemOffset(IProductionItem item)
    {
