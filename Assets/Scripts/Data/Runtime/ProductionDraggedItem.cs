...
public class ProductionDraggedItem
{
    ...
    /// </summary>
    public GridItemController originalController { get; private set; }
    ...
    /// </summary>
    public IProductionItem item { get; private set; }

    /// <summary>
    /// Gets or sets the InventoryController currently in control of this item
    /// </summary>
    public GridItemController currentController;
    ...
    public ProductionDraggedItem(
        Canvas canvas,
        GridItemController originalController,
        Vector2Int originPoint,
        IProductionItem item,
        Vector2 offset)
    {
     ...
     */
    private Vector2 GetDraggedItemOffset(GridRenderer renderer, IProductionItem item)
    {
