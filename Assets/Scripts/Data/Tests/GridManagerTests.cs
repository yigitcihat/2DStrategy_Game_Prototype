...
{
    IProductionItem CreateFullItem(int width, int height, bool canBeDropped = true)
    {
        ...
        return new TestItem(null, new GridShape(shape), canBeDropped);
    }
    ...
    */
    ...
    {
        var inventory = new GridManager(new TestProvider(), 16, 8);
    ...
    */
    ...
    {
        var inventory = new GridManager(new TestProvider(), 4, 4);
    ...
    {
        var inventory = new GridManager(new TestProvider(), 2, 2);
        inventory.TryAdd(CreateFullItem(2, 2));
    ...
    */
    ...
    {
        var inventory = new GridManager(new TestProvider(), 8, 4);
    ...
    */
    ...
    {
        var inventory = new GridManager(new TestProvider(), 3, 3);
        var item = CreateFullItem(3, 3);
        inventory.TryAdd(item);
    ...
    {
        var inventory = new GridManager(new TestProvider(), 1, 1);
        var callbacks = 0;
    ...
    */
    ...
    public void DropAll_OnItemDroppedInvokedForAllItems()
    {
        ...
        var droppedItems = new List<IProductionItem>();
        inventory.onItemDropped += (i) =>
        {
            droppedItems.Add(i);
        };
